 ...
 * operations on a dictionary: adding words, checking if a word is correct, 
 * and getting a list of suggestions for misspelled words.
 */
public interface SpellingDictionary {
   ...
   * @param word The word to verify if its spelling is OK.
   ...
   * If you set the threshold value too low, you may get no suggestions for 
   * a given word.
   * </p>
   * <p>
